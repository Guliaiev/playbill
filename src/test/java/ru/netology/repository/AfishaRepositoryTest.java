...
class AfishaRepositoryTest {
    ...
    private MovieItem first = new MovieItem(1, "first", "films.com/1", 1);
    private MovieItem second = new MovieItem(2, "second", "films.com/2", 2);
    private MovieItem third = new MovieItem(3, "third", "films.com/3", 1);
